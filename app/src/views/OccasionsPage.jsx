  ...
  },
  {
    ...
    signatureDishes: [
      ...
      },
      {
        ...
        description: '68% West Godavari craft dark chocolate ganache enrobed in single-estate nibs and sea salt.',
      },
      {
        name: 'Whole-Milk Irani Chai & Maskabun',
        partner: 'Cafe Niloufer',
        dietary: 'VEG',
        pricePerHead: 160,
        image: '/dishes/cafe-niloufer-chai-bun.jpg',
        description: 'Scalded creamy decoction brewed in brass samovars with warm butter-crusted buns.',
      },
      {
        name: 'Silver-Vark Royal Meetha Paan',
        partner: 'Dimmy Pan Palace',
        dietary: 'VEG',
        pricePerHead: 95,
        image: '/dishes/dimmy-meetha-paan.jpg',
        description: 'Fragrant betel leaf infused with organic gulkand, dried fruits, and edible silver foil.',
      },
    ],
    courseStructure: [
      { phase: 'Amuse-Bouche & Starters', time: '0:00 – 0:40', desc: 'Charcoal-grilled Galouti kebabs with mint coriander emulsion.' },
      { phase: 'The Imperial Dastarkhwan', time: '0:40 – 1:40', desc: 'Slow-simmered handi biryani, saffron gravy, and freshly baked roomali rotis.' },
      { phase: 'Single-Origin Cacao & Sweets', time: '1:40 – 2:20', desc: 'Manam craft truffles paired with warm saffron Shahi Tukda.' },
      { phase: 'Royal Samovar Chai & Paan', time: '2:20+', desc: 'Niloufer brass samovar tea service and Dimmy silver-vark digestifs.' },
    ],
  },
  {
    id: 'occ_family',
